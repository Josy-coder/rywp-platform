...
export default function ProjectsPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
                  ...
                  {project.status === 'ongoing' && (
                    <div className="mb-4">
                      ...
                      <div className="w-full bg-gray-200 h-2">
                        <div
                          className="bg-light-blue h-2 transition-all duration-300"
      ...
      {/* Project Themes Deep Dive */}
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-light text-gray-900 mb-4">Project Themes</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Our projects span multiple thematic areas, each addressing critical aspects of Rwanda&#39;s water challenges
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div id="wash-projects" className="bg-gray-50 p-8">
              <div className="w-16 h-16 bg-dark-blue mb-6 flex items-center justify-center">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3" />
                </svg>
              </div>
              <h3 className="text-xl font-medium text-gray-900 mb-4">WASH Projects</h3>
              <p className="text-gray-600 mb-6">Infrastructure development and service delivery projects focused on water supply, sanitation, and hygiene improvements.</p>
              <div className="space-y-2 text-sm text-gray-600">
                <div>• Smart water management systems</div>
                <div>• Rural water supply enhancement</div>
                <div>• Urban infrastructure upgrades</div>
              </div>
            </div>

            <div id="nature-based" className="bg-gray-50 p-8">
              <div className="w-16 h-16 bg-light-blue mb-6 flex items-center justify-center">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
                </svg>
              </div>
              <h3 className="text-xl font-medium text-gray-900 mb-4">Nature-Based Solutions</h3>
              <p className="text-gray-600 mb-6">Environmental conservation and restoration projects that protect water resources through natural ecosystem approaches.</p>
              <div className="space-y-2 text-sm text-gray-600">
                <div>• Watershed protection initiatives</div>
                <div>• Constructed wetland systems</div>
                <div>• Community conservation programs</div>
              </div>
            </div>

            <div className="bg-gray-50 p-8">
              <div className="w-16 h-16 bg-lighter-blue mb-6 flex items-center justify-center">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
              </div>
              <h3 className="text-xl font-medium text-gray-900 mb-4">Innovation & Technology</h3>
              <p className="text-gray-600 mb-6">Cutting-edge technology solutions and innovative approaches to address complex water challenges.</p>
              <div className="space-y-2 text-sm text-gray-600">
                <div>• IoT and smart water systems</div>
                <div>• Advanced treatment technologies</div>
